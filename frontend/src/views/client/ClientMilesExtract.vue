    ...
    <main>
      ...
      >
        <template #cell-type="{ item }">
          <ColorBadge
            :label="this.labelName[item.type]"
            :green="item.type === 'entry'"
            :red="item.type === 'exit'"
          />
        </template>
      ...
      tableColumns: [
        {
          key: "performedDate",
          label: "Data",
          // formatter: (val) => this.$filters.formatDateTime(val) ?? '-',
        },
        { key: "reservationCode", label: "Código Reserva" },
        {
          key: "price",
          label: "Valor",
          // formatter: (val) => this.$filters.formatMoney(val) ?? '-',
        },
        {
          key: "quantity",
          label: "Quantidade",
          // formatter: (val) => `${val} milhas` ?? '-',
        },
        { key: "description", label: "Descrição" },
        {
          key: "type",
          label: "Tipo",
          // formatter: (val) => this.labelName[val] ?? '-',
        },
      ],
    };
  },
