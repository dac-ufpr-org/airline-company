...
/**
 * Configuração do RabbitMQ para o serviço de SAGA.
 * Define as filas e exchanges necessárias para a orquestração.
 */
@Configuration
public class RabbitMQConfig {
    ...
    /**
     * Define a fila de autenticação.
     */
    @Bean
    public Queue authQueue() {
        return new Queue(QueueNames.AUTH_QUEUE, true);
    }
    ...
    /**
     * Define a fila de compensação.
     */
    @Bean
    public Queue compensacaoQueue() {
        return new Queue(QueueNames.COMPENSACAO_QUEUE, true);
    }

    /**
     * Define a fila de email.
     */
    @Bean
    public Queue emailQueue() {
        return new Queue(QueueNames.EMAIL_QUEUE, true);
    }
} 